...
const Hero = () => {
  ...
  const socialIcons = [FaInstagram, FaGithub, FaLinkedin];
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          <div
            className={`flex-1 flex items-center justify-center transition-all duration-1200 ease-out ${
              isVisible
          ...
          <div
            className={`flex-1 text-center lg:text-left transition-all duration-1200 delay-300 ease-out ${
              isVisible
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-gray-400 text-lg mb-10 max-w-2xl leading-relaxed">
                ...
                <span className="text-blue-400 font-medium">amazing</span>{" "}
                together!
              </p>
            </div>
